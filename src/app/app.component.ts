...
import { locale as navigationarabic } from 'app/i18n/ar';
...
export class AppComponent implements OnInit, OnDestroy
{
        ...
        this._fuseConfigService.config
            ...
            .subscribe((config) => {
                ...
                if(this._translateService.currentLang=='ar'){
                    this.document.body.classList.add("Ar");
                }
    ...
    private subscribeToEvents(): void {  
        ...
        this.signalRService.messageReceived.subscribe((message1: any) => {  
          this._ngZone.run(() => {  
            if (message1.recipientId == this.userDetails.id) {
                this.alertify.success('You Have New Message: '+message1.fullname);
            }       
          });  
        });  
      }  
    ...
    private subscribeToEventsOffer(): void {  
        this.signalRService.OfferReceived.subscribe((message1: any) => {  
          this._ngZone.run(() => {  
                this.alertify.success('there is a new Offer');
          });  
        });  
      }
    /**
